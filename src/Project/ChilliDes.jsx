...
import ChilliimgDes from "./chillidesimg.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            flowers and colorful fruit. If you grow these plants indoors, you
            should use supplemental artificial lighting for healthy plants and
            good fruiting.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          ...
          <Typography style={sectionStyle}>
            ...
            well-rotted manure will both improve tilth and add trace nutrients
            for healthier plants. If your soil is heavy clay, plant your peppers
            in raised beds or use containers for good drainage. If growing
            ornamental peppers in pots, any all-purpose potting mix will be
            sufficient.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          ...
          <Typography style={sectionStyle}>
            While ornamental peppers react badly to dry conditions, they do not
            like to be waterlogged, either. Water deeply whenever the soil's
            surface feels dry, and aim for a moisture level like that of a
            wrung-out sponge. About 1 inch of water per week is recommended.
            Check container-grown plants often for water, as they dry out more
            quickly than in-ground plants.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Temperature and Humidity🌡️
          </Typography>
          <Typography style={sectionStyle}>
            Like tomatoes, ornamental peppers are members of the Solanaceae
            family and both enjoy full sun and hot weather. Temperatures of 75
            degrees F and up stimulate rapid growth. Planting peppers in cold
            soil may cause them to remain stunted for the entire growing season.
            Humidity is a less important growth factor, as long as roots stay
            moist. However, temperatures above 90 degrees may cause blossom
            drop, but the plants will rebound once the temperatures cool.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathv">
