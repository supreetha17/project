...
import StringimgDes from "./stringimgdes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            String of pearls plants thrive on a combination of direct and
            indirect sunlight, totaling between six and eight hours a day.
            They're best when kept in direct sunlight during the softer morning
            hours, then moved to a spot that gets diffused, indirect light, or
            partial shade during the harsher afternoon hours.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          </Typography>
          <Typography style={sectionStyle}>
            ...
            pearls plants, but sandy soil is best. A good choice for this plant
            is a cactus potting mix. Alternatively, you can use a three-to-one
            mixture of potting soil to sharp sand. These plants are susceptible
            to root rot, so make sure their soil is well-draining.3 Plant them
            in a container that boasts ample drainage holes at its base. Terra
            cotta or clay pots can also help wick away excess moisture from the
            soil.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          ...
          <Typography style={sectionStyle}>
            ...
            spring and summer, then reduce water during the winter months. If
            you notice the succulent's spherical leaves flattening, it's a good
            indicator that the plant needs more water. You will likely need to
            water your plant once every seven to 14 days. Plants in hotter
            climates, outdoors during the summer, or in porous terra cotta pots
            might need water closer to every seven days, all depending on rain
            frequency and temperatures. If the soil is dry to the touch down to
            the first one-half inch of soil, that's a good sign your plant is
            thirsty. Water thoroughly; you're done watering once the water
            drains out of the bottom of the pot. Succulents need good drainage,
            and be careful not to overwater your string of pearls plants.
            Succulents are drought-resistant but cannot survive with wet, soggy
            roots.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            prefers low humidity, so avoid placing it in any already-humid areas
            of your home, like a kitchen or bathroom.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathap">
