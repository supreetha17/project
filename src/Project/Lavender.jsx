...
import LavenderimgDes from "./lavenderdes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Lavender plants grown in full sunlight are the best way to guarantee
            a lot of buds and big, full bushes.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          </Typography>
          <Typography style={sectionStyle}>
            Lean soil (soil without a lot of organic matter mixed in) will
            encourage a higher concentration of oils (and good smells), so go
            easy on the organic matter and fertilizer. Lavender plants prefer
            well-drained soil that is on the drier side, so if you're using a
            traditional potting mix, be sure to add in some sand for drainage.
            An alkaline or especially chalky soil will enhance your lavender's
            fragrance, while any pH below about 6.5 will likely cause lavender
            plants to be very short-lived.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          </Typography>
          <Typography style={sectionStyle}>
            Lavender is a resilient plant that is extremely drought-tolerant
            once established. When first starting your lavender plants, keep
            them regularly watered during their first growing season. After
            that, they can handle extended periods of drought—in fact, too much
            water can lead to fungal disease and root rot.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            months or high humidity in the summer. If humidity is a problem,
            make sure you have plenty of space between your plants for airflow,
            and always plant your bushes in a sunny location. Protect lavender
            plants from harsh winter winds by planting them next to a stone or
            brick wall to provide additional heat and protection. If you live in
            an area where the ground routinely freezes and thaws throughout the
            winter, your lavender plants will benefit from a layer of mulch
            applied after the ground initially freezes to protect the roots.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathh">
