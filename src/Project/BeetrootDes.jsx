...
import BeetrootimgDes from "./beetrootimgdes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Beets prefer to grow in full sun, meaning at least six hours of
            direct sunlight on most days. However, they can tolerate some light
            shade.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          ...
          <Typography style={sectionStyle}>
            A light, rich, well-draining soil with a slightly acidic to neutral
            pH is best. Rocks, clay, weeds, and anything else that can interfere
            with root development should be removed. Moreover, beets need boron
            in the soil to prevent black heart, a condition that causes deformed
            leaves and corky black spots on the roots. You can provide boron by
            using compost or seaweed extract as a soil amendment.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          </Typography>
          <Typography style={sectionStyle}>
            Provide at least 1 inch of water every week. Mulching will help to
            keep the soil from drying out and getting too warm.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            between 50 and 85 degrees Fahrenheit are ideal. Humidity also
            typically isn't an issue as long as proper soil moisture is
            maintained and there's air flow around the plants to help inhibit
            fungal growth.
          </Typography>
          <br></br>
          <br></br>
