      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            grow well in heavy clay and wet soils. A slightly acidic to neutral
            soil pH is ideal (6.0 to 7.0).
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          </Typography>
          <Typography style={sectionStyle}>
            Rosemary is quite drought-tolerant once the plant is established,
            and it’s better to water sparingly rather than overwater them. Allow
            the top few inches of soil to dry out between waterings, and then
          ...
          <Typography style={sectionStyle}>
            ...
            rosemary varieties can’t survive temperatures below 30 degrees, but
            they have good heat tolerance. They prefer temperatures between 55
            degrees and 80 degrees. Moreover, high humidity can lead to rot and
            fungal issues, especially if there isn’t enough air circulation
            around the plant.
          </Typography>
          <br></br>
          <br></br>
