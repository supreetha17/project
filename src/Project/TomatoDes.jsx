...
import TomatoimgDes from "./tomatoimgdes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Tomatoes require eight hours or more of direct sunlight daily to
            grow, flower, and fruit. In warmer regions like the southern United
            States, tomatoes might benefit from some afternoon shade during the
          ...
          <Typography style={sectionStyle}>
            Water tomato plants regularly to ensure they're receiving at least
            one inch of water per week. Consistent watering will help produce
            the best-quality fruit.
            <br />
            Apply water directly to the soil at the plant's root zone rather
            than sprinkling water overhead and wetting the foliage. Keeping the
            foliage dry will reduce the chance of fungal diseases.
            <br />
            Mulching with organic material like hay, straw, or grass clippings
            that have not been treated with pesticides can help retain soil
            moisture.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            Tomatoes can grow well at a variety of humidity levels, but they
            need warm temperatures to survive and thrive. Temperatures below 50
            degrees Fahrenheit can stunt growth and damage the plant's ability
            to produce flowers and fruit. Daytime temperatures above 85 degrees
            can cause blossom drop, but you can help keep plants withstand the
            heat by mulching the soil around plants and keeping them well
            watered.
          </Typography>
          <br></br>
          <br></br>
