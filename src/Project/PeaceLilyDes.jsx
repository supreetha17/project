...
import PeacelilyimgDes from "./peacelilydes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            ...
            shade-loving plants in their native habitats. But peace lilies
            indoors need a bit more filtered light. (Some varieties can
            withstand more light than others.) An east-facing window is a prime
            spot to place a peace lily in your house.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          </Typography>
          <Typography style={sectionStyle}>
            ...
            organic matter. These plants are native to tropical canopy
            conditions where the soil is packed with deteriorating plant
            material, so you'll find the best success with soil that mimics this
            composition. Additionally, the plant is also very sensitive to
            too-damp soil conditions, so be sure to choose a well-draining
            mixture.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          ...
          <Typography style={sectionStyle}>
            ...
            often you should water a peace lily depends on container size and
            how fast the soil drains, but, in general, water when the top inch
            of soil has dried out. In winter, reduce watering but never allow
            the soil to dry out completely. If your water at home is highly
            chlorinated, it's a good idea to use filtered or distilled water.
            Alternatively, you can allow tap water to sit for several days until
          ...
          <Typography style={sectionStyle}>
            ...
            that fall below 55 degrees Fahrenheit; the plant will die when
            exposed to prolonged cold temperatures. The ideal temperature range
            for your peace lily is 65 to 80 degrees Fahrenheit. Spritz the
            leaves every week with softened or distilled water throughout the
            summer growing season to raise humidity.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathap">
