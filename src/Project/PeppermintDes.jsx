...
import PeppermintimgDes from "./peppermintdes.jpeg";
      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Peppermint can grow in full sun or partial shade. It can even
            tolerate some dappled shade, unlike most herbs.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          </Typography>
          <Typography style={sectionStyle}>
            The adaptability of peppermint is one of its best features; it is
            also one of its worst features, allowing it to grow almost anywhere,
            making it a nuisance. Peppermint’s ideal soil is rich, loamy, and
            moist, though it's known to grow along trailside ditches and craggy
            outcrops—it can and will grow anywhere.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          </Typography>
          <Typography style={sectionStyle}>
            Consistently moist soil is the key to making sure your peppermint
            plant is happy and possesses tons of flavor. But be careful not to
            overdo it. Peppermint, like most mints, cannot tolerate standing
            water or soaking soil. Having soggy roots is a surefire way to kill
            or harm your plant.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            Peppermint is unusually hardy and can survive light frosts but
            cannot endure extended cold snaps in cold climates, USDA Cold
            Hardiness Zones 5 and below. Its ideal growing conditions fall
            between 55 to 70 degrees Fahrenheit, but it can survive nicely above
            and below that range with little negative effect. If you expect
            temperatures to be on the warmer side, keep the soil moist while
            also watching for excess growth from humid conditions.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathh">
