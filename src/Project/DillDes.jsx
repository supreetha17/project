...
import DillimgDes from "./dilldes.jpeg";
    ...
    >
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Dill plants prefer soil that is rich, loose, and well-draining. Dill
            is not particular about its soil pH but thrives best in slightly
            acidic soil. Keep in mind, dill plants have a taproot (a central
            dominant root from which smaller roots grow), so compacted soil
            could be a problem. Because dill can self-sow, it's important that
            you either plant it in a spot where it’s allowed to roam or where
            you can harvest it before it goes to seed.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          </Typography>
          ...
          <Typography style={sectionStyle}>
            Dill plants are very cold-hardy and can tolerate temperatures that
            dip as low as 25 degrees Fahrenheit. That being said, the optimal
            temperature for your dill plant is when the soil is about 70 degrees
            Fahrenheit, which will happen during the late spring and summer in
            most USDA hardiness zones. Dill has no special humidity
            requirements.
          </Typography>
          <br></br>
          <br></br>
