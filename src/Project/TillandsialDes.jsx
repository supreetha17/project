...
import TillandsiaimgDes from "./tillandsiaimgdes.jpeg";
    ...
    >
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Although Tillandsia cyanea can be grown as air plants, what makes
            them unique is their ability also to be grown in containers. Their
            rooting system is small and fragile, so care should be taken when
            potting them, and the pots don't need to be large. Whatever potting
            medium you use, it should be particularly well-draining. Spongy and
            porous orchard bark, or peat moss and leaf mold mixes are popular
            choices. There are even mixtures available especially for Bromeliad
            species.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Water💧
          ...
          <Typography style={sectionStyle}>
            Although pink quills don't need as much water as the average
            houseplant, they do tend to need more than most Tillandsia species.
            If they're potted up, depending on the time of year and how dry the
            conditions are, they could need watering anywhere from every two
            weeks to every couple of months. Although some enthusiasts recommend
            deep watering and then removing any excess water that has drained
            through, most agree that more regular misting is the best option.
            Soggy rots are one thing that will cause major problems for this
            plant, and this can be a problem when watering at the base. In the
            warmer seasons, gentle misting every week, allowing the runoff to
            wet the roots, may be needed. Always allow the potting medium to dry
            out before rewatering and, if in doubt, underwatering rather than
            overwatering is the more sensible option. During the colder months,
            watering should be infrequent. The Tillandsia cyanea is chlorine
            sensitive, so rainwater or filtered tap water is the preferred
            choice.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            It shouldn't come as a surprise that this tropical species
            appreciates warm conditions. Ideal minimum temperatures for
            encouraging blooms are around 75 degrees Fahrenheit. They aren't
            fans of dry conditions either. If there isn't enough humidity, the
            foliage can develop brown tips.
          </Typography>
          <br></br>
          <Link to="/pathap">
